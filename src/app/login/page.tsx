  ...
  return (
    <main className="auth-layout">
      <section className="auth-story">
        ...
        <div className="story-proof"><span><CheckIcon /> R01–R29 y jerarquía</span><span><CheckIcon /> Correcciones auditadas</span><span><CheckIcon /> Excel original preservado</span></div>
