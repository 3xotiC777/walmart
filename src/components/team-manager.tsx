...
interface Productivity { userId: string; tasks: number; alerts: number; cells: number; rows: number; correct: number }

export function TeamManager({ members, productivity }: { members: Member[]; productivity: Productivity[] }) {
